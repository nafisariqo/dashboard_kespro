<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0">
          ...
          <span class="ms-1 font-weight-bold">Mentari Dashboard</span>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('vidio')? 'active' : '' }} " href="/vidio">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Table Video Learning</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('quiz')? 'active' : '' }}" href="/quiz">
              ...
              <span class="nav-link-text ms-1">Table Quiz</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('artikel')? 'active' : '' }} " href="/artikel">
              ...
              <span class="nav-link-text ms-1">Table Article</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('komen')? 'active' : '' }} " href="/komen">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Table Comment</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ Request::is('webinar')? 'active' : '' }} " href="/webinar">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Table Webinar</span>
            </a>
          </li>
